...
// Floating "Add transaction" button for a single account's register. Mirrors
// HomeAddTransaction but pre-selects the account being viewed.
export function AccountAddTransaction({
  accountId,
  accounts,
  categories,
}: {
